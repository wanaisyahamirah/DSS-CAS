...
<html lang="en">
  <head>
    ...
    <title>DSS CAS | Edit Weightage</title>
                      ...
                      <div class="rounded-t mb-0 px-4 py-3 border-0 bg-gray-100 mb-6">
                        <div class="flex flex-wrap items-center">
                          ...
                          <div class="relative w-full px-4 max-w-full flex-grow flex-1 text-right">
                            <a href="edit_weightage.jsp?event_id=<%=eventid %>" class="bg-indigo-500 text-white active:bg-indigo-600 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150">
                                Customise Weightage
                            </a>
                        </div>
                        </div>
                          ...
                          <div class="flex justify-center flex-wrap justify-items-center">
                            ...
                            <div class="mx-2 flex w-1/4 flex-col break-words bg-white mb-6 shadow-lg rounded-lg bg-blueGray-700">
                              <div class="flex justify-between text-right px-5 my-3">
                                <a href="edit_merit_weightage.jsp?event_id=<%=eventid%>" class="text-white"><span class="text-bold">Merit</span> </a>
                            

                              </div>
                              <blockquote class="relative p-8 mb-4">
                                <p class="text-white"><span class="text-bold">Weightage: <%=merit_percentage%> </span> </p>

                              </blockquote>
                            </div>
                            <div class="mx-2 flex w-1/4 flex-col break-words bg-white mb-6 shadow-lg rounded-lg bg-blueGray-700">
                              <div class="flex justify-between text-right px-5 my-3">
                                <a href="edit_merit_weightage.jsp?event_id=<%=eventid%>" class="text-white"><span class="text-bold">CGPA</span> </a>

                              </div>
                              <blockquote class="relative p-8 mb-4">
                                <p class="text-white"><span class="text-bold">Weightage: <%= cgpa_percentage%> </span> </p>

                              </blockquote>
                            </div>
                            <div class="mx-2 flex w-1/4 flex-col break-words bg-white mb-6 shadow-lg rounded-lg bg-blueGray-700">
                              <div class="flex justify-between text-right px-5 my-3">
                                <a href="edit_merit_weightage.jsp?event_id=<%=eventid%>" class="text-white"><span class="text-bold">Intangible / Others</span> </a>

                              </div>
                              <blockquote class="relative p-8 mb-4">
                                <p class="text-white"><span class="text-bold">Weightage: <%= intangible_percentage%> </span> </p>
