                    ...
                    <div class="flex flex-col w-full">
                        ...
                        <div class="w-full mx-autp items-center flex justify-between md:flex-nowrap flex-wrap md:px-10 px-4">
                            <div>
                                ...
                                <a class="text-white text-sm uppercase hidden lg:inline-block font-semibold" href="event-form.jsp">
                                    / Create Event | Program Director 
                                </a>
                                                ...
                                                <div class="w-full mb-12 xl:mb-6 px-4">
                                                    <div class="relative flex flex-col min-w-0 break-words w-full mb-6 rounded-lg bg-blueGray-100 border-0">
                                                        ...
                                                        <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                                                            ...
                                                            %>
                                                            <form id="create-event-form" method="post" action="<%=request.getContextPath()%>/EventController">
                                                                <input type="hidden" id="ProgramDirectorId" name="createdBy" value="<%=createdBy%>">
                                                                ...
                                                                <div class="flex flex-wrap">
                                                                    <div class="w-full lg:w-6/12 px-4">
                                                                        <div class="relative w-full mb-3">
                                                                            ...
                                                                            <input required placeholder="Insert name of the event" type="text" name="eventName" required class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
                                                                        </div>
                                                                    </div>
                                                                    <div class="w-full lg:w-6/12 px-4">
                                                                        <div class="relative w-full mb-3">
                                                                            ...
                                                                            <input required placeholder="Select due date for the final submission" datepicker datepicker-buttons name="eventDueDate" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
                                                                        </div>
                                                                    </div>
                                                                    <div class="w-full lg:w-6/12 px-4">
                                                                        <div class="relative w-full mb-3">
                                                                            ...
                                                                            <input required type="number" step="0.01" min="0.0" placeholder="Select due date for the final submission" name="minCgpa" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                    <div class="w-full lg:w-6/12 px-4">
                                                                        <div class="relative w-full mb-3">
                                                                            ...
                                                                            <input required type="number" min="1" placeholder="Select due date for the final submission"  name="minMerit" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
                                                                    ...
                                                                    <div class="mt-3 w-full px-4">
                                                                        <div class="relative w-full mb-3">
                                                                            <button name="action" value="registerEvent" 
