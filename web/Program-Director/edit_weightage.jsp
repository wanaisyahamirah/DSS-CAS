<%-- 
    Document   : customize-weightage-form
    Created on : 4 Dec 2022, 6:09:26 PM
    Author     : aisy
--%>
        ...
        <div class="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
          ...
          <div
            ...
            <ul class="md:flex-col md:min-w-full flex flex-col list-none">
              ...
              <li class="items-center">
                <a href="event-list.jsp?eventid=<%=eventid%>"
                   class="text-xs uppercase py-3 font-bold block text-blueGray-700 hover:text-blueGray-500">
      ...
      <div class="relative md:ml-64 bg-blueGray-50">
        ...
        <nav class="absolute top-0 left-0 w-full z-10 bg-transparent md:flex-row md:flex-nowrap md:justify-start flex items-center p-4">
          <div class="w-full mx-autp items-center flex justify-between md:flex-nowrap flex-wrap md:px-10 px-4">
            <a class="text-white text-sm uppercase hidden lg:inline-block font-semibold" href="award-list.jsp?eventid=<%%>">Settings | Customise Weightage</a>
                          ...
                          <div class="px-4 bg-blueGray-900">
                            <div class="relative w-full pr-4 max-w-full flex-grow flex-1">
                              ...
                              <span class="uppercase font-semibold text-md text-blueGray-200">
                                This is the weightage for the event 
                                <span class="uppercase font-semibold text-md text-blue-200"><%=event.getEventName()%></span>
                              </span><br>
                              <%
                                  if (request.getSession().getAttribute("wrong_total_percentage") != null) {
                              %>
                              <span class="uppercase font-semibold text-md text-red-600">
                                Please make sure total weightage is equal to 100%
                              </span>
                ...
                <div class="flex flex-wrap mt-4">
                  <div class="w-full mb-12 xl:mb-6 px-4">
                    <div class="relative min-w-0 break-words bg-white mb-6 shadow-lg rounded">
                      <form id="edit-weightage-form" method="post" action="<%=request.getContextPath()%>/EventController">
                        <div class="rounded-t mb-0 px-4 py-3 border-0 bg-gray-100 mb-6">
                          <div class="flex flex-wrap items-center">
                            ...
                            <div class="relative w-full px-4 max-w-full flex-grow flex-1 text-right">
                              <button type="submit" name="action" value="edit_weightage" class="bg-indigo-500 text-white active:bg-indigo-600 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150">
                                Save
                              </button>
                            </div>
                          </div>
                          ...
                          <table>
                            ...
                            <div class="flex justify-center flex-wrap justify-items-center">
                              <%
                                  ...
                                  int max_percentage_to_update = 98;
                              %>
                              <div class="mx-2 flex w-1/4 flex-col break-words bg-white mb-6 shadow-lg rounded-lg bg-blueGray-700">
                                <div class="flex justify-between text-right px-5 my-3">
                                  <a href="edit_merit_weightage.jsp?event_id=<%=eventid%>" class="text-white"><span class="text-bold">CGPA ( original is <%=cgpa_percentage%>% )</span> </a>
                                  <input type="hidden" id="event_id" name="event_id" value="<%=eventid%>">
                                </div>
                                <blockquote class="relative p-8 mb-4">

                                  <input required class="w-full" placeholder="Edit percentage here" type="number" id="merit_percentage" name="cgpa_percentage" min="1" max="<%=max_percentage_to_update%>">

                                </blockquote>
                              </div>
                              <div class="mx-2 flex w-1/4 flex-col break-words bg-white mb-6 shadow-lg rounded-lg bg-blueGray-700">
                                <div class="flex justify-between text-right px-5 my-3">
                                  <a href="edit_merit_weightage.jsp?event_id=<%=eventid%>" class="text-white"><span class="text-bold">Merit ( original is <%=merit_percentage%>% )</span> </a>

                                </div>
                                <blockquote class="relative p-8 mb-4">
                                  <input required class="w-full" placeholder="Edit percentage here" type="number" id="merit_percentage" name="merit_percentage" min="1" max="<%=max_percentage_to_update%>">
                                </blockquote>
                              </div>
                              <div class="mx-2 flex w-1/4 flex-col break-words bg-white mb-6 shadow-lg rounded-lg bg-blueGray-700">
                                <div class="flex justify-between text-right px-5 my-3">
                                  <a href="edit_merit_weightage.jsp?event_id=<%=eventid%>" class="text-white"><span class="text-bold">Intangible ( original is <%=intangible_percentage%>% )</span> </a>
                                </div>
                                <blockquote class="relative p-8 mb-4">
                                  <input required class="w-full" placeholder="Edit percentage here" type="number" id="merit_percentage" name="intangible_percentage" min="1" max="<%=max_percentage_to_update%>">
                                </blockquote>
                              </div>
                            </div>
                            </tr>
