                    ...
                    <div class="flex flex-col w-full">
                        ...
                        <div class="w-full mx-autp items-center flex justify-between md:flex-nowrap flex-wrap md:px-10 px-4">
                            <div>
                                ...
                                <a class="text-white text-sm uppercase hidden lg:inline-block font-semibold" href="award-list.jsp?eventid=<%=eventid%>">
                                                    ...
                                                    <div class="px-4 bg-blueGray-900">
                                                        <div class="relative w-full pr-4 max-w-full flex-grow flex-1">
                                                            ...
                                                            <span class="uppercase font-semibold text-md text-blueGray-200">
                                                                Click the 
                                                                <span class="uppercase font-semibold text-md text-blue-200">View eligible candidate button</span>
                                                        ...
                                                        <div class="mx-2 flex w-1/4 flex-col break-words bg-white mb-6 shadow-lg rounded-lg bg-blueGray-700">
                                                            ...
                                                            <blockquote class="relative p-8 mb-4">
                                                                ...
                                                                <div class="w-full text-center mt-4">
                                                                    <a href="eligible-candidate-list.jsp?awardid=<%=award.getAward_id()%>" class="w-full bg-pink-500 text-white active:bg-pink-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none ease-linear transition-all duration-150"
                                                                       type="button">
                                                                        View Eligible Candidate
                                                                    </a>
                                                                </div>
