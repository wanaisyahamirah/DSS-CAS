            ...
            <div class="relative md:ml-64 bg-blueGray-50">
                ...
                <nav class="absolute top-0 left-0 w-full z-10 bg-transparent md:flex-row md:flex-nowrap md:justify-start flex items-center p-4">
                    <div class="w-full mx-autp items-center flex justify-between md:flex-nowrap flex-wrap md:px-10 px-4">
                        <a class="text-white text-sm uppercase hidden lg:inline-block font-semibold" href="award-candidate.jsp">Candidate List For Evalutaion | Lecturer</a>
                                                    ...
                                                    <div class="px-4 bg-blueGray-900">
                                                        <div class="relative w-full pr-4 max-w-full flex-grow flex-1">
                                                            ...
                                                            <span class="uppercase font-semibold text-md text-blueGray-200">
                                                                Please rate candidates in the aspect of their intagible criterias
                                                            </span>
                                                        </div> 
                                                    </div>
                                                </div>
                                    ...
                                    <div class="w-full mb-12 xl:mb-0 px-4">
                                        <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded">
                                            ...
                                            <div class="block w-full overflow-x-auto">
                                                <!-- Projects table -->
                                                <table class="items-center w-full bg-transparent border-collapse text-center    ">
                                                    <thead>
                                                    ...
                                                    <tbody>
                                                        <%
                                                            ...
                                                            List<Integer> candidate_id_list = userDao.findUsersByRoleId(5);
                                                            for (Integer candidate_id : candidate_id_list) {
                                                                UserDao userDao1 = new UserDaoImpl();
                                                                User candidate = userDao1.findById(candidate_id);

                                                                AwardNomineeDao dao = new AwardNomineeDaoImpl();
                                                                int record = dao.getNumberOfRecordByUserId(candidate_id);
                                                                if (record == 0) {
                                                        %>
                                                        <tr>
                                                            <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-center"><%=candidate_counter%>.</td>
                                                            <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-center">
                                                                <a href="award-candidate-details.jsp?nomineeid=<%=candidate_id %>"><%=candidate.getName()%></a>
                                                            </td>
                                                            <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-center">
                                                                <a href="award-candidate-rate.jsp?user_id=<%=candidate_id%>" class="px-4 py-1 text-white font-light tracking-wider bg-pink-600 rounded hover:bg-gray-300 hover:text-gray-900">
                                                                    Rate
                                                                </a>
                                                            </td>
                                                        </tr>
