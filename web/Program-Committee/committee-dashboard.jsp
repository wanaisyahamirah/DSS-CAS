...
<html>
    <head>
        ...
        <title>DSS CAS | Program Committe Dashboard</title>
            ...
            <div class="relative md:ml-64 bg-blueGray-50">
                <nav class="absolute top-0 left-0 w-full z-10 bg-transparent md:flex-row md:flex-nowrap md:justify-start flex items-center p-4">
                    <div class="w-full mx-autp items-center flex justify-between md:flex-nowrap flex-wrap md:px-10 px-4">
                        <a class="text-white text-sm uppercase hidden lg:inline-block font-semibold" href="sdc-dashboard.jsp">Dashboard | Program Committee</a>
                        <div class="flex items-center space-x-6">
                            <a class="text-white text-sm uppercase hidden lg:inline-block font-semibold">Due date: <%=currentEvent.getEventDate() == null ? "Not available" : currentEvent.getEventDate()%></a>
                                ...
                                <div class="flex flex-col justify-between">
                                            ...
                                            <div class="px-4 bg-blueGray-900">
                                                <div class="relative w-full pr-4 max-w-full flex-grow flex-1">
                                                    ...
                                                    <span class="font-semibold text-md text-blueGray-200">
                                                        ...
                                                        <%} else {%>
                                                        <%
                                                            if (!Objects.isNull(currentEvent) && currentEvent.getDss_status().equals("done")) {%>
                                    ...
                                    <div class="flex flex-wrap">
                                        ...
                                        <%
                                            ...
                                            List<Integer> lecturerList = userDao1.findUsersByRoleId(4);
                                        %>
                                        <div class="w-full lg:w-6/12 xl:w-3/12 px-4">
                                            <div class="relative flex flex-col min-w-0 break-words bg-white rounded mb-6 xl:mb-0 shadow-lg">
                                                <div class="flex-auto p-4">
                                        ...
                                        <%
                                            ...
                                            List<Integer> committeeList = userDao2.findUsersByRoleId(3);
                                        %>                    
                                        <div class="w-full lg:w-6/12 xl:w-3/12 px-4">
                                            <div class="relative flex flex-col min-w-0 break-words bg-white rounded mb-6 xl:mb-0 shadow-lg">
                                                <div class="flex-auto p-4">
                                                    <div class="flex flex-wrap">
                                                        <div class="relative w-full pr-4 max-w-full flex-grow flex-1">
                                                            <h5 class="text-blueGray-400 uppercase font-bold text-xs">
                                                                Number of Registered Committees
                                                            </h5>
                                                            <span class="font-semibold text-xl text-blueGray-700">
                                                                <%=committeeList.size()%>
                                                            </span>
                                        ...
                                        <div class="rounded-t mb-0 px-4 py-3 bg-transparent">
                                            <div class="flex flex-wrap items-center">
                                                <div class="relative w-full max-w-full flex-grow flex-1">
                                                    ...
                                                    <h2 class="uppercase text-blueGray-700 text-xl font-semibold">
                                            ...
                                            <table class="items-center w-full bg-transparent border-collapse">
                                                ...
                                                <%
                                                    ...
                                                    for (Award award : awardList) {
                                                        int winnnerid = awardDao.getWinnerIdByAwardId(award.getAward_id());
