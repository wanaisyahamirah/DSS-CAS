...
<html lang="en">
    <head>
        ...
        <title>DSS CAS | CGPA Request List</title>
            ...
            <div class="relative md:ml-64 bg-blueGray-50">
                <nav class="absolute top-0 left-0 w-full z-10 bg-transparent md:flex-row md:flex-nowrap md:justify-start flex items-center p-4">
                    <div class="w-full mx-autp items-center flex justify-between md:flex-nowrap flex-wrap md:px-10 px-4">
                        <a class="text-white text-sm uppercase hidden lg:inline-block font-semibold" href="cgpa-request-list.jsp">CGPA Request List | Student Development Committee</a>
                                        ...
                                        <div class="block w-full overflow-x-auto">
                                            ...
                                            <table class="items-center w-full bg-transparent border-collapse">
                                                ...
                                                <%
                                                    ...
                                                    List<CGPARequest> requestList = cgpaRequestDao.listPendingCGPARequest();
                                                    User user;
                                                    int listCounter = 1;
                                                    for (CGPARequest CGPARequest : requestList) {
                                                        UserDao userDao = new UserDaoImpl();
                                                        user = userDao.findById(CGPARequest.getUser_id());
                                                %>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <%
                                                            ...
                                                            double cgpa = CGPARequest.getCgpa();
                                                        %>
                                                        <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                                            <%=df.format(cgpa)%>
                                                        </td>
                                                        <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                                            <form action="<%=request.getContextPath()%>/CGPARequestController" method="GET">
                                                                <input name="requestId" value="<%=CGPARequest.getRequest_id()%>" type="hidden"/>
                                                        ...
                                                        <td class="flex border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                                            <form id="form" action="<%=request.getContextPath()%>/CGPARequestController" class="pl-0 p-6 text-center" method="post">
                                                                <input type="hidden" name="requestId" value="<%=CGPARequest.getRequest_id()%>">
                                                                <input type="hidden" name="current_user_id" value="<%=logged_in_user.getUserid()%>">
                                                                <input type="hidden" name="candidateid" value="<%=CGPARequest.getUser_id()%>">
                                                                <input type="hidden" name="cgpa_value" value="<%=CGPARequest.getCgpa()%>">
                                                                <button type="submit" name="action" value="approveCGPARequest" 
                                                                        data-modal-toggle="popup-modal-approve-merit-<%=CGPARequest.getRequest_id()%>" type="button" class="text-white bg-green-600 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                                                    Approve
                                                                </button>
                                                            </form>
                                                            <form id="form" action="<%=request.getContextPath()%>/CGPARequestController" class="pl-0 p-6 text-center" method="post">
                                                                <input type="hidden" name="current_user_id" value="<%=logged_in_user.getUserid()%>">
                                                                <input type="hidden" name="requestId" value="<%=CGPARequest.getRequest_id()%>">
                                                                <button type="submit" name="action" value="rejectCGPARequest" 
                                                                        data-modal-toggle="popup-modal-approve-merit-<%=CGPARequest.getRequest_id()%>" type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                                                    Reject
                                                                </button>
                                                            </form>
                                                        </td>
