...
<html lang="en">
    ...
    <body class="text-blueGray-700 antialiased">
        <%
            ...
            if (eventid == 0) {
                response.sendRedirect(request.getContextPath() + "/Student-Development-Committee/sdc-dashboard.jsp");
            }
        %>
            ...
            <div class="relative md:ml-64 bg-blueGray-50">
                ...
                <nav class="absolute top-0 left-0 w-full z-10 bg-transparent md:flex-row md:flex-nowrap md:justify-start flex items-center p-4">
                    <div class="w-full mx-autp items-center flex justify-between md:flex-nowrap flex-wrap md:px-10 px-4">
                        <a class="text-white text-sm uppercase hidden lg:inline-block font-semibold" href="award-list.jsp?eventid=<%=eventid%>">Nomination | Student Development Committee</a>
                                                    ...
                                                    <div class="px-4 bg-blueGray-900">
                                                        <div class="relative w-full pr-4 max-w-full flex-grow flex-1">
                                                            ...
                                                            <span class="uppercase font-semibold text-md text-blueGray-200">
                                                                Click the 
                                                                <span class="uppercase font-semibold text-md text-blue-200">View nominee button</span>
                                                                to select a winner from the top three nominees with the highest rank
                                                            </span>
                                                        </div> 
                                                    </div>
                                                </div>
...
%>
                                                                <div class="w-full text-center mt-4">
                                                                    <a href="award-candidate.jsp?awardid=<%=award.getAward_id()%>" class="w-full bg-pink-500 text-white active:bg-pink-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none ease-linear transition-all duration-150"
                                                                       type="button">
                                                                        View Nominee
                                                                    </a>
                                                                </div>
