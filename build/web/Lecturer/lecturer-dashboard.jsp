...
<html>
    <head>
        ...
        <title>DSS CAS | Lecturer Dashboard</title>
            ...
            <div class="relative md:ml-64 bg-blueGray-50">
                <nav class="absolute top-0 left-0 w-full z-10 bg-transparent md:flex-row md:flex-nowrap md:justify-start flex items-center p-4">
                    <div class="w-full mx-autp items-center flex justify-between md:flex-nowrap flex-wrap md:px-10 px-4">
                        <a class="text-white text-sm uppercase hidden lg:inline-block font-semibold" href="sdc-dashboard.jsp">Dashboard | Lecturer</a>
                ...
                <div class="flex flex-col justify-between">
                    <div style="bg-gray-900">
                        ...
                        <div class="px-4 md:px-10 mx-auto w-full m-12">
                            <div class="my-4 py-2 px-4">
                                <div class="flex justify-center">
                                    <h1 class="text-blueGray-400 uppercase font-bold text-xs m-2">Student Evaluation Progress Bar</h1>
                                </div>    
                                <script>
                                    let progress = 0;
