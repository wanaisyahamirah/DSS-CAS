...
<html lang="en">
    <head>
        ...
        <title>DSS CAS | Merit Form</title>
            ...
            <div class="relative md:ml-64 bg-blueGray-50">
                <nav class="absolute top-0 left-0 w-full z-10 bg-transparent md:flex-row md:flex-nowrap md:justify-start flex items-center p-4">
                    <div class="w-full mx-autp items-center flex justify-between md:flex-nowrap flex-wrap md:px-10 px-4">
                        <a class="text-white text-sm uppercase hidden lg:inline-block font-semibold" href="merit-form.jsp">Merit Form | Candidate</a>
                                                ...
                                                <div class="flex items-center bg-gray-900 rounded-lg m-4 px-6">
                                                    ...
                                                    <div class="px-4 bg-blueGray-900">
                                                        <div class="relative w-full pr-4 max-w-full space-y-2">
                                                            ...
                                                            <p class="pb-3 uppercase font-semibold text-md text-blueGray-200">Uploaded merit evidence must be a pdf file generated from MyNemo
                                                                <span class="block text-blue-500 font-bold">Mynemo > HEPA > MyStar | print.. > Save as PDF</span>
                                                            </p>
                                                        </div> 
                                                    </div>
                                                </div>
                                                ...
                                                <div class="w-full mb-12 xl:mb-6 px-4">
                                                    <div class="relative flex flex-col min-w-0 break-words w-full mb-6 rounded-lg bg-blueGray-100 border-0">
                                                        ...
                                                        <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                                                            <form action="<%=request.getContextPath()%>/MeritRequestController" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <div class="flex flex-wrap">
                                                                    ...
                                                                    <div class="w-full px-4">
                                                                        <div class="relative w-full mb-3">
                                                                            ...
                                                                            <input required name="merit_value" type="number" min="1" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" id="grid-state">
                                                                        </div>
                                                                    </div>
                                                                    <div class="mt-3 w-full px-4">
                                                                        <div class="relative w-full mb-3">
                                                                            ...
                                                                            %>
                                                                            <button type="submit" name="action" value="merit_submission" 
                                                                                ...
                                                                                Submit Merit Evidence
                                                                            </button>
                                                                            <%} else {%>
                                                                            <button disabled type="submit" name="action" value="cgpa_submission" 
                                                                                    class="w-full bg-pink-500 text-white active:bg-pink-600 hover:bg-pink-200 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150">
                                                                                Submit Merit Evidence (Disabled because no event is live currently)
                                                                            </button>
                                                                            <%}%>
                                                                        </div>
                                                                    </div>
