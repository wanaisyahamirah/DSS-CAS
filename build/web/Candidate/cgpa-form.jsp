                                                ...
                                                <div class="flex items-center bg-gray-900 rounded-lg m-4 px-6">
                                                    ...
                                                    <div class="px-4 bg-blueGray-900">
                                                        <div class="relative w-full pr-4 max-w-full space-y-2">
                                                            ...
                                                            <p class="pb-3 uppercase font-semibold text-md text-blueGray-200">Uploaded CGPA evidence must be a pdf file generated from MyNemo
                                                                <span class="block text-blue-500 font-bold">Mynemo > Akademik > Keputusan Peperiksaan Keseluruhan > Versi BM/Versi BI | print.. > Save as PDF</span>
                                                            </p>
                                                        </div> 
                                                    </div>
                                                </div>
                                                ...
                                                <div class="w-full mb-12 xl:mb-6 px-4">
                                                    <div class="relative flex flex-col min-w-0 break-words w-full mb-6 rounded-lg bg-blueGray-100 border-0">
                                                        ...
                                                        <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                                                            <form action="<%=request.getContextPath()%>/CGPARequestController" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <div class="flex flex-wrap">
                                                                    ...
                                                                    <div class="w-full px-4">
                                                                        <div class="relative w-full mb-3">
                                                                            ...
                                                                            <input name="cgpa" required type="number" step="0.01" min="0.0" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" id="grid-state">
                                                                        </div>
                                                                    </div>
                                                                    <div class="mt-3 w-full px-4">
                                                                        <div class="relative w-full mb-3">
                                                                            ...
                                                                            %>
                                                                            <button type="submit" name="action" value="cgpa_submission" 
                                                                                ...
                                                                                Submit CGPA Evidence
                                                                            </button>
                                                                            <%} else {%>
                                                                            <button disabled type="submit" name="action" value="cgpa_submission" 
                                                                                    class="w-full bg-pink-500 text-white active:bg-pink-600 hover:bg-pink-200 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150">
                                                                                Submit CGPA Evidence (Disabled because no event is live currently)
                                                                            </button>
                                                                            <%}%>
                                                                        </div>
                                                                    </div>
