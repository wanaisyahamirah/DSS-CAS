...
<html lang="en">
  <head>
    ...
    <title>DSS CAS | Create Award</title>
  ...
  <body class="text-blueGray-700 antialiased">
    <%
        ...
        int createdBy = curent_user.getUserid();
            ...
            <div class="w-full mx-autp items-center flex justify-between md:flex-nowrap flex-wrap md:px-10 px-4">
              <div>
                <a class="text-blueGray-200 text-sm uppercase hidden lg:inline-block font-semibold hover:text-blueGray-500"  href="award-list.jsp?eventid=<%=eventId%>">
                  Award List | Program Committee 
                </a>
                <a class="text-white text-sm uppercase hidden lg:inline-block font-semibold" href="award-form.jsp?event_id=<%=eventId%>">
                  / Create Award | Program Committee 
                </a>
                        ...
                        <div class="w-full mb-12 xl:mb-6 px-4">
                          <div class="relative flex flex-col min-w-0 break-words w-full mb-6 rounded-lg bg-blueGray-100 border-0">
                            ...
                            <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                              <form id="create-event-form" method="post" action="<%=request.getContextPath()%>/AwardController">
                                <input type="hidden" id="committee_id" name="created_by" value="<%=createdBy%>">
                                <input type="hidden" id="committee_id" name="event_id" value="<%=eventId%>">
                                ...
                                <div class="flex flex-wrap">
                                  <div class="w-full lg:w-6/12 px-4">
                                    <div class="relative w-full mb-3">
                                      ...
                                      <input required placeholder="Insert name of the event" type="text" name="award_name" required class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">
                                    </div>
                                  </div>
                                  <div class="w-full lg:w-6/12 px-4">
                                    <div class="relative w-full mb-3">
                                      ...
                                      <select name="year_criteria" id="year_program" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" id="grid-state">
                                        <option class="text-center" value="year_1">Year 1</option> 
                                        <option class="text-center" value="year_2">Year 2</option>  
                                        <option class="text-center" value="year_1_and_2">Year 1 and 2</option>
                                        <option class="text-center" value="year_3">Year 3</option>
                                        <option class="text-center" value="all_year">All Year of Study</option>
                                      </select>
                                    </div>
                                  </div>
                                  <div class="w-full lg:w-6/12 px-4">
                                    <div class="relative w-full mb-3">
                                      ...
                                      <!--class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">-->
                                      <select name="program_criteria" id="year_program" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" id="grid-state">
                                        <option class="text-center" value="se">Kejuruteraan Perisian</option>
                                        <option class="text-center" value="im">Informatik Maritim</option>
                                        <option class="text-center" value="kma">Komputeran Mudah Alih</option>
                                        <option class="text-center" value="all">All Program of Study</option>
                                      </select>
                                    </div>
                                  </div>
                                  <div class="w-full lg:w-6/12 px-4">
                                    <div class="relative w-full mb-3">
                                      ...
                                      <!--class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150">-->
                                      <select name="gender_criteria" id="year_program" class="border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" id="grid-state">
                                        <option class="text-center" value="male">Lelaki</option>
                                        <option class="text-center" value="female">Perempuan</option>
                                        <option class="text-center" value="all">Lelaki dan Perempuan</option>
                                      </select>
                                    </div>
                                  </div>  
                                  ...
                                  <div class="mt-3 w-full px-4">
                                    <div class="relative w-full mb-3">
                                      <button name="action" value="registerAward" 
